...
By default, idlers ignores idle inhibitors — timers will fire even if an application (e.g. Discord during a voice call) is requesting that idle be inhibited. This requires compositor support for version 2 of the `ext-idle-notify-v1` protocol. The `ext-idle-notify-v1` support matrix [here](https://wayland.app/protocols/ext-idle-notify-v1#compositor-support) may help you determine which version of the protocol your compositor supports.
